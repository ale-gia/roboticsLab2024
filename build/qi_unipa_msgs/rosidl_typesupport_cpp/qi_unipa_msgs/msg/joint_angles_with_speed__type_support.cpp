...
static const _JointAnglesWithSpeed_type_support_symbol_names_t _JointAnglesWithSpeed_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, qi_unipa_msgs, msg, JointAnglesWithSpeed)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, qi_unipa_msgs, msg, JointAnglesWithSpeed)),
  }
};
...
{
  return &::qi_unipa_msgs::msg::rosidl_typesupport_cpp::JointAnglesWithSpeed_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, qi_unipa_msgs, msg, JointAnglesWithSpeed)() {
  return get_message_type_support_handle<qi_unipa_msgs::msg::JointAnglesWithSpeed>();
}
