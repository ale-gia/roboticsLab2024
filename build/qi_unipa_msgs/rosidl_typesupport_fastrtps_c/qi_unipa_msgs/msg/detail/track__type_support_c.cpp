...
#include "qi_unipa_msgs/msg/detail/track__rosidl_typesupport_fastrtps_c.h"
...
using _Track__ros_msg_type = qi_unipa_msgs__msg__Track;
...
size_t get_serialized_size_qi_unipa_msgs__msg__Track(
  const void * untyped_ros_message,
...
static uint32_t _Track__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_qi_unipa_msgs__msg__Track(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_qi_unipa_msgs
size_t max_serialized_size_qi_unipa_msgs__msg__Track(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = qi_unipa_msgs__msg__Track;
    is_plain =
      (
...
static size_t _Track__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_qi_unipa_msgs__msg__Track(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, qi_unipa_msgs, msg, Track)() {
