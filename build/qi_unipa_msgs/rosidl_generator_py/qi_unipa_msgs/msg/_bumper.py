...
class Bumper(metaclass=Metaclass_Bumper):
    ...
    def __init__(self, **kwargs):
        ...
        self.back = kwargs.get('back', float())
    ...
    def back(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'back' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'back' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._back = value
