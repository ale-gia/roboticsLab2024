...
bool qi_unipa_msgs__msg__track__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("qi_unipa_msgs.msg._track.Track", full_classname_dest, 30) == 0);
  }
  qi_unipa_msgs__msg__Track * ros_message = _ros_message;
  {  // target_name
...
PyObject * qi_unipa_msgs__msg__track__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("qi_unipa_msgs.msg._track");
