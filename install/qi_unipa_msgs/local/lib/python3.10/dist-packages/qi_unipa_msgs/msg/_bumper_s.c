...
bool qi_unipa_msgs__msg__bumper__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("qi_unipa_msgs.msg._bumper.Bumper", full_classname_dest, 32) == 0);
  }
  qi_unipa_msgs__msg__Bumper * ros_message = _ros_message;
  {  // left
  ...
  {  // back
    ...
    assert(PyFloat_Check(field));
    ros_message->back = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * qi_unipa_msgs__msg__bumper__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("qi_unipa_msgs.msg._bumper");
  ...
  {  // back
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->back);
    {
