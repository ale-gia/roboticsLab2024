...
bool qi_unipa_msgs__msg__joint_angles_with_speed__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("qi_unipa_msgs.msg._joint_angles_with_speed.JointAnglesWithSpeed", full_classname_dest, 63) == 0);
  }
  qi_unipa_msgs__msg__JointAnglesWithSpeed * ros_message = _ros_message;
  {  // names
...
{
  /* NOTE(esteve): Call constructor of JointAnglesWithSpeed */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("qi_unipa_msgs.msg._joint_angles_with_speed");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "JointAnglesWithSpeed");
